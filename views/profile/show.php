    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <?php
                    // echo Html::img($profile->getAvatarUrl(230), [
            ...
            <div class="col-sm-6 col-md-8">
                ...
                <ul style="padding: 0; list-style: none outside none;">
                    ...
                    <?php endif; ?>
                    <li><i class="glyphicon glyphicon-time text-muted"></i> <?= Yii::t('user', 'Joined on {0, date}', strtotime($profile->user->creation_date)); ?></li>
                </ul>
